...
# 顶点集合：/home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/accounts.csv
# 边集合： /home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/transactions.csv
# spacename： AMLSim1K
#  顶点的tag 由/home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/accounts.csv中的字段指定，
#  顶点 id 由 acct_id 指定
#  边的 edge_type 由 /home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/transactions.csv 中的字段指定
...
class AMLSimDataLoader:
    def __init__(self, 
                 ...
                 username='root', 
                 password='nebula', 
                 accounts_file="/home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/accounts.csv",
                 transactions_file = "/home/chency/GraphLLM/graphllm/graph_data/AMLSim/1K/transactions.csv"
                ):
        """
        初始化AMLSim数据加载器
