...
from dynamic_tool_registrar import register_discovered_tools, GenericToolOutput
...
@mcp.tool()
def initialize_graph(vertices: List[Dict[str, Any]], edges: List[Dict[str, Any]], directed: bool = True, multiedge: bool = False) -> Dict[str, Any]:
