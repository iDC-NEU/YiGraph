...
class DatasetService:
    ...
    def __init__(self):
        ...
        # 缓存策略：当前通过 ResponseCollector 实时收集响应，
        # 如需跨请求缓存结果，可在此初始化持久化缓存（如 LRU Cache）。

    async def create_knowledge_base(
        self, file_path: str, graph_name: str, db_name: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        创建知识库（从文本文件）
        ...
        try:
                ...
                try:
                    ...
                    if data.get("type") == "data" and data.get("contentType") == "json":
                        ...
                        if content.get("success"):
                            return {"success": True, "data": content.get("data", {})}
            ...
            return {"success": True, "message": "知识库创建请求已提交"}
    ...
    async def delete_knowledge_base(
        self, graph_name: str, db_name: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        删除知识库
        ...
        try:
            ...
            message = {"action": "delete_kb", "graph_name": graph_name}
            ...
            return {"success": True, "message": "知识库删除请求已提交"}

        except Exception as e:
            logger.error(f"删除知识库失败: {str(e)}")
            return {"success": False, "error": str(e)}

    async def get_triplets(self, graph_name: str) -> Dict[str, Any]:
        """
        获取知识库的三元组
        ...
        try:
            ...
            message = {"action": "get_triplets", "graph_name": graph_name}
