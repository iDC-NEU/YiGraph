...
DATA_SCHEMA_PATH = PROJECT_ROOT / "data_pipeline" / "data_transformer" / "dataset_schemas"
GRAPH_SCHEMA_PATH = DATA_SCHEMA_PATH / "graph_schemas.yaml"
TABLE_SCHEMA_PATH = DATA_SCHEMA_PATH / "table_schemas.yaml"
TEXT_SCHEMA_PATH = DATA_SCHEMA_PATH / "text_schemas.yaml"
